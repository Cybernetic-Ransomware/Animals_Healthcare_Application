...
from AHC_app.medical_notes.models.type_measurement_notes import BiometricRecord
        ...
        len(
            {
                instance
                for instance in (
                    instance.weight_biometric_record,
                    instance.height_biometric_record,
                    instance.custom_biometric_record,
                )
